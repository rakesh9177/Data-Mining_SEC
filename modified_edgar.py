...
def create_parser():
    ...
    parser.add_argument('--download',type=int, default=10,
                        help="Specify the number of files to download")
    return parser
...
def main():
    ...
    download_forms(index_dir, form_dir, args.download, args.overwrite, args.debug)
...
@timeit
def download_forms(index_dir: str, form_dir: str, download: int, overwrite: bool = False, debug: bool = False):
    ...
    download_paths = download_paths[:download]
    # Download forms
